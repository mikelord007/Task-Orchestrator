...
TOOL = {
    ...
    "description": (
        ...
        "fields (labels, assignees, milestone, state, closed_at, updated_at, "
        "comment count) are withheld and 'comments' and 'linked' come back "
        "empty with a note explaining why -- that data is the answer you are "
        "being asked to produce; infer it from other issues instead.\n"
        "\n"
